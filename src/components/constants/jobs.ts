export default [
  {
    ...
    responsibilities: [
      ...
      {
        id: 2,
        description: 'Designed and developed the frontend of a web application that tested the performance of regular expressions',
      ...
      {
        id: 4,
        description: 'Developed a web app that gave government contractors a collaborative online platform to create work proposals',
